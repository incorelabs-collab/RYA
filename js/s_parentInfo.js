var pageSenatorParentInfo = {
    ...
    getSpousePage: function(id) {
        ...
        app.displayPage("s_spouseInfo.html");
    },
...
$(document).ready(function() {
    app.setCurrentPage("s_parentInfo.html");
                                                    ...
                                                    function(tx, r) {
                                                        if(r.rows.length > 0) {
                                                            ...
                                                            for(var i =0;i< r.rows.length; i++) {
                                                                kidsOnParentString += "<div class='container detailContent'><div class='row'><a onclick='pageSenatorParentInfo.getKidsModal("+r.rows.item(i).id+")'><div class='col-xs-4'><img src='img/customer.png' class='thumbnail'></div><div class='col-xs-8'><div class='detailKidName'>"+r.rows.item(i).Name+"</div></div></a></div></div>";
                                                            }
                                                            $("#kidsOnParent").append(kidsOnParentString);
                                                        }
                                                        if(userData.has_partner == 1) {
                                                            parentBodyString += "<div class='row listItems'><a onclick='pageSenatorParentInfo.getSpousePage("+spouseUserId+")'><div class='col-xs-10 col-sm-11 pull-left'><h4 class='spouseInfoTitleLabel'>Spouse</h4><h5 class='spouseInfoTitleDetail'>"+spouseName+"</h5></div><div class='col-xs-2 col-sm-1 pull-right'><span class='glyphicon glyphicon-chevron-right Icon'></span></div></a></div>";
                                                        ...
                                                        pageSenatorParentInfo.checkImage(commonMaleId);
                                                        $("[data-toggle='popover']").popover();
                                                        parentHeaderString = "";
                                                        parentBodyString = "";
                                                        kidsOnParentString = "";
